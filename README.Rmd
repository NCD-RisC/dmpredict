...
NCD Risk Factor Collaboration (NCD-RisC). Global variation in diabetes diagnosis and prevalence based on fasting glucose and hemoglobin A1c. *Nature Medicine* 2023; **29**: 2885-2901. https://doi.org/10.1038/s41591-023-02610-2
...
* `iso` [ISO alpha-3 code](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3) for the country the study was conducted in
...
If `iso` is not recognised, provide a string with one of the following in a variable named `Superregion`:
